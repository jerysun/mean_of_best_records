 ...
 * describe: Unit tests for the project mean_of_best_records, involving
 *           hash table, index, set, multimap, data persistence (
 *           serialization, deserialization), unique_ptr, shared_ptr,
 *           move semantics, time and string operations
